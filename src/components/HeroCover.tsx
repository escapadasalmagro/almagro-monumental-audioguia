...
export const HeroCover: React.FC<HeroCoverProps> = ({
  ...
  return (
    <section
      ...
      className="relative w-full rounded-3xl overflow-hidden shadow-lg border border-[#3a2a1d]/30 min-h-[420px] sm:min-h-[460px] md:min-h-[380px] flex flex-col justify-between md:justify-center p-5 sm:p-6 md:p-10 text-center mb-6"
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center pt-2 sm:pt-4 md:pt-0 space-y-3">
        ...
        <p className="text-xs sm:text-sm md:text-base text-[#F9F7F2]/90 leading-relaxed max-w-[320px] sm:max-w-[420px] md:max-w-[540px] mx-auto font-normal drop-shadow-xs">
      ...
      <div className="relative z-20 w-full max-w-lg mx-auto space-y-3 pt-4 sm:pt-6">
        {/* Search Input */}
        ...
        <button
          ...
          onClick={onOpenMap}
          className="w-full bg-[#C5A059] hover:bg-[#b8944f] text-[#4A3728] font-black text-sm py-3.5 rounded-2xl uppercase tracking-wider shadow-md flex items-center justify-center gap-2 transition-all active:scale-[0.98] cursor-pointer border border-[#d8c5a4]"
        >
