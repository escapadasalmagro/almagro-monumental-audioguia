...
export const INITIAL_MONUMENTS: Monument[] = [
  {
    ...
    imageUrl: '/images/corral-de-comedias.jpg',
    thumbnailUrl: '/images/corral-de-comedias.jpg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/iglesia-de-san-agustin.jpg',
    thumbnailUrl: '/images/iglesia-de-san-agustin.jpg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/claustro-del-convento-de-la-asuncion.jpg',
    thumbnailUrl: '/images/claustro-del-convento-de-la-asuncion.jpg',
    originalText: {
  ...
  },
  {
    ...
    visitDurationMinutes: 35,
    imageUrl: '/images/palacio-de-juan-de-jedler.jpg',
    thumbnailUrl: '/images/palacio-de-juan-de-jedler.jpg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/teatro-municipal.jpg',
    thumbnailUrl: '/images/teatro-municipal.jpg',
    originalText: {
  ...
  },
  {
    ...
    visitDurationMinutes: 40,
    imageUrl: '/images/museo-del-encaje-y-la-blonda.png',
    thumbnailUrl: '/images/museo-del-encaje-y-la-blonda.png',
    originalText: {
