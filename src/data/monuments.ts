...
export const INITIAL_MONUMENTS: Monument[] = [
  {
    ...
    imageUrl: '/images/corral-de-comedias/corral foto audio.jpeg',
    thumbnailUrl: '/images/corral-de-comedias/corral foto audio.jpeg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/iglesia-de-san-agustin/san agustin audio.jpg',
    thumbnailUrl: '/images/iglesia-de-san-agustin/san agustin audio.jpg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/claustro-del-convento-de-la-asuncion/convento audio.jpg',
    thumbnailUrl: '/images/claustro-del-convento-de-la-asuncion/convento audio.jpg',
    originalText: {
  ...
  },
  {
    ...
    visitDurationMinutes: 35,
    imageUrl: '/images/palacio-de-juan-de-jedler/juan jedler audio.jpg',
    thumbnailUrl: '/images/palacio-de-juan-de-jedler/juan jedler audio.jpg',
    originalText: {
  ...
  },
  {
    ...
    imageUrl: '/images/teatro-municipal/teatro audio.jpg',
    thumbnailUrl: '/images/teatro-municipal/teatro audio.jpg',
    originalText: {
  ...
  },
  {
    ...
    visitDurationMinutes: 40,
    imageUrl: '/images/museo-del-encaje-y-la-blonda/encaje almagro.png',
    thumbnailUrl: '/images/museo-del-encaje-y-la-blonda/encaje almagro.png',
    originalText: {
